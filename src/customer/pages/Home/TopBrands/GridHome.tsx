...
const TopBrand = () => {
  ...
  // console.log("TopBrand component - homePage:", homePage);
  // console.log("TopBrand grid data:", homePage.homePageData?.grid);
  
  // Add a safety check
  if (!homePage.homePageData?.grid || homePage.homePageData.grid.length < 6) {
    // console.error("Grid data is missing or incomplete");
    return <div className="p-4">Loading grid data...</div>;
  }
  return (
