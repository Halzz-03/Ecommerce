...
import { Box, Button, Divider, Grid, Modal, Rating } from '@mui/material';
import { Wallet, Shield, WorkspacePremium, LocalShipping, ShieldMoonSharp } from '@mui/icons-material';
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-10'>
                ...
                <section>
                    ...
                    <div className='flex justify-between items-center py-2 border w-[180px] px-3 mt-5'>
                        ...
                        <span>{products.product?.numRatings}Ratings</span>
                    </div>
                    ...
                    <div className="mt-12 flex items-center gap-5">
                        ...
                        <Button
                            ...
                            startIcon={wishlist.wishlist && products.product && isWishlisted(wishlist.wishlist, products.product) ? <FavoriteIcon sx={{ color: teal[500] }} /> : <FavoriteBorderIcon />}
                            onClick={handleAddWishlist}
                        >
                            {wishlist.wishlist && products.product && isWishlisted(wishlist.wishlist, products.product) ? 'Remove from Wishlist' : 'Add to Wishlist'}
                        </Button>
                    </div>
                    ...
                    <div className="ratings w-full mt-10">
                        ...
                        <div className='mt-10'>
                            <div className="space-y-5">
                                ...
                                <Button onClick={() => navigate(`/reviews/${productId}`)}>View  {review.reviews.length} Reviews</Button>
                            </div>
                        </div>
                    </div>
                </section>
