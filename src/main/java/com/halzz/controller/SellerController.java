...
import com.halzz.service.*;
import com.halzz.service.impl.CustomeUserServiceImplementation;
...
public class SellerController {
    ...
    public ResponseEntity<ApiResponse> sentLoginOtp(@RequestBody VerificationCode req) throws MessagingException, SellerException {
        ...
        String subject = "Cartify Login Otp";
...
//        Seller savedSeller = sellerService.createSeller(seller);
    ...
    public ResponseEntity<Seller> createSeller(@RequestBody Seller seller) throws SellerException, MessagingException {
        ...
        // Instead of sending a verification email, you can directly return the success response.
        String subject = "Cartify Account Created";
        String text = "Your account has been successfully created. Please log in to continue.";
//        emailService.sendVerificationOtpEmail(seller.getEmail(), "", subject, text); // You can customize this email
