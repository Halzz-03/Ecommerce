...
// Import all your existing slices
...
import homeSlice from './Customer/Customer/AsyncThunk'
import DealSlice from "./Admin/DealSlice";
import AdminSlice from "./Admin/AdminSlice";
import homeCategorySlice from './Admin/AdminSlice';
import homePageSlice from './Customer/Customer/AsyncThunk';
...
const rootReducer = combineReducers({
  ...
  // Add homeCategory slice
  homeCategory: homeCategorySlice,
});

const store = configureStore({
  reducer: rootReducer,
  middleware: (getDefaultMiddlerware) => getDefaultMiddlerware().concat(thunk),
});
